...
ROUND_HEADING_VARIANTS = {
    "R128": ["Round of 128"],
    "R64": ["Round of 64"],
    "R32": ["Round of 32"],
    "R16": ["Round of 16"],
    "QF": ["Quarter-Finals", "Quarterfinals"],
    "SF": ["Semi-Finals", "Semifinals"],
    "F": ["Finals", "Final"],
}
...
def find_round_heading_position(draw_html: str, round_code: str, start_at: int = 0) -> int:
    ...
    for label in ROUND_HEADING_VARIANTS[round_code]:
        pos = draw_html.find(label, start_at)
        if pos != -1:
